...
function addNewCategory(bookId = selectedBookId) {
    ...
    // Icon options
    const iconOptions = [
        { type: 'folder', svg: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.93a2 2 0 0 1-1.66-.9l-.82-1.2A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13c0 1.1.9 2 2 2Z"></path></svg>' },
        { type: 'book', svg: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>' },
        { type: 'document', svg: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline></svg>' },
        { type: 'star', svg: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>' },
        { type: 'heart', svg: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>' },
        { type: 'tag', svg: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"></path><line x1="7" y1="7" x2="7.01" y2="7"></line></svg>' }
    ];
    ...
    iconOptions.forEach(icon => {
        ...
        iconBtn.setAttribute('data-icon', icon.type);
        ...
        iconBtn.style.backgroundColor = 'var(--background-color)';
        ...
        if (icon.type === 'folder') {
            ...
            iconBtn.style.backgroundColor = 'var(--primary-color-light)';
        }
    ...
    privateInput.id = 'categoryPrivate';
    privateInput.style.marginRight = '8px';
    
    const privateLabel = document.createElement('label');
    privateLabel.htmlFor = 'categoryPrivate';
    privateLabel.textContent = 'Private';
    
    privateGroup.appendChild(privateInput);
    privateGroup.appendChild(privateLabel);
    
    // Pinned Checkbox
    const pinnedGroup = document.createElement('div');
    pinnedGroup.style.display = 'flex';
    pinnedGroup.style.alignItems = 'center';
    
    const pinnedInput = document.createElement('input');
    pinnedInput.type = 'checkbox';
    pinnedInput.id = 'categoryPinned';
    pinnedInput.style.marginRight = '8px';
    
    const pinnedLabel = document.createElement('label');
    pinnedLabel.htmlFor = 'categoryPinned';
    pinnedLabel.textContent = 'Pinned';
    
    pinnedGroup.appendChild(pinnedInput);
    pinnedGroup.appendChild(pinnedLabel);
    
    optionsGroup.appendChild(privateGroup);
    optionsGroup.appendChild(pinnedGroup);
    ...
    cancelButton.style.backgroundColor = 'var(--background-color)';
