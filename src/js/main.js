...
function setupSidebarNavigation() {
    ...
    if (adminIcon) {
        adminIcon.addEventListener('click', function(e) {
            ...
            this.classList.add('active');
            // Use the enhanced showAdminPage from membershipPages.js which includes the new sections
            // showAdminPage() - local function (old)
            membershipPages.showAdminPage(); // call the function from membershipPages.js
        });
    }
    ...
    if (teamIcon) {
        teamIcon.addEventListener('click', function(e) {
            ...
            this.classList.add('active');
            // Use the enhanced showTeamPage from membershipPages.js
            // showTeamPage() - local function (old)
            membershipPages.showTeamPage(); // call the function from membershipPages.js
        });
    }
